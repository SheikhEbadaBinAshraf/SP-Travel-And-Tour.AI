...
# Streamlit config
st.set_page_config(page_title="SP Travel And Tour.AI",page_icon="🌍")
st.title("SP Travel And Tour.AI ✈️")

# Define the template outside the function
template = """
You are a travel assistant chatbot your name is SP Travel And Tour.AI designed to help users plan their trips and provide travel-related information. Here are some scenarios you should be able to handle:
...
6. Weather Updates: Give current weather updates for specific destinations or regions. Include temperature forcasts, precipitation changes, and any weather advisories.

7. Local Attractions: Suggest loacal attractions and points of interest based on the user's destination. Highlight must-see landmarks, museums, parks, and recreational activities.
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello, I am SP Travel And Tour.AI How can I help you?"),
    ]
